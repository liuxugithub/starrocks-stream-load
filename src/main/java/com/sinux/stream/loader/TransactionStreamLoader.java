...
import static com.sinux.stream.loader.StreamLoadConstants.getBeginUrl;
import static com.sinux.stream.loader.StreamLoadConstants.getCommitUrl;
import static com.sinux.stream.loader.StreamLoadConstants.getPrepareUrl;
import static com.sinux.stream.loader.StreamLoadConstants.getRollbackUrl;
        ...
        try (CloseableHttpClient client = clientBuilder.build()) {
            ...
            switch (status) {
                case StreamLoadConstants.RESULT_STATUS_OK:
                    manager.callback(streamLoadResponse,transaction.getDatabase()+"@"+ transaction.getTable());
                    return true;
