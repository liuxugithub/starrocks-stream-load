...
import com.sinux.stream.loader.DefaultStreamLoader;
import com.sinux.stream.loader.EnvUtils;
import com.sinux.stream.loader.LabelGenerator;
import com.sinux.stream.loader.LabelGeneratorFactory;
import com.sinux.stream.loader.LoadMetrics;
...
public class StreamLoadManagerV2 implements StreamLoadManager, Serializable {
    ...
    public void callback(StreamLoadResponse response, String tableId) {
        ...
        if (streamLoadListener != null) {
            streamLoadListener.onResponse(response,tableId);
        }
